    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        join.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String pwc = pwck.getText().toString();
                String po = pon.getText().toString();
                //hideKeyboard();

                //로그인 정보 미입력 시
                if (id.trim().length() == 0 || pw.trim().length() == 0 || pwc.trim().length() == 0 || po.trim().length() == 0
                        || id == null || pw == null || pwc == null || po == null) {
